			...
			<div className="container-wrapper py-12 lg:py-16">
				...
				<div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
					...
					<aside className="space-y-8">
						...
						{popularPosts.length > 0 && (
							<section>
								<div className="flex items-center gap-3 mb-6">
									...
									<h3 className="text-xl font-bold">پربیننده</h3>
								</div>
						...
						{/* Newsletter CTA */}
						<section className="p-6 rounded-xl bg-gradient-to-br from-primary/10 to-accent/10 border">
							<h3 className="text-lg font-bold mb-2">به‌روز بمانید</h3>
							<p className="text-sm text-muted-foreground mb-4">
								آخرین مقالات و اخبار را در ایمیل خود دریافت کنید.
							</p>
